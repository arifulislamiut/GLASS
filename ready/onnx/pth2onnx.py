...
class GLASS_onnx(torch.nn.Module):
    def __init__(self):
        ...
        state_dict = torch.load('../results/models/backbone_0/wfdd_grid_cloth/ckpt_best_571.pth', map_location='cuda')
        self.glass.pre_projection.load_state_dict(
            state_dict["pre_projection"])
